        ...
        <div class="login-card">
            ...
            <form class="login-card-form" method="POST">
                ...
                <div class="form-item">
                    ...
                    <input type="text" placeholder="Meta (ex: ganhar massa muscular, perder 5 kg, reduzir gordura, etc)." id="meta" name="meta" required>
                </div>
                <div class="form-item">
                ...
                <div class="form-item">
                    ...
                    <input type="text" placeholder="Peso (ex:59.90)" id="peso" name="peso" required>
                </div>
                <div class="form-item">
                    <span class="form-item-icon material-symbols-rounded">height</span>
                    <input type="text" placeholder="Altura (ex: 1.80)" id="altura" name="altura" required>
                </div>
                <div class="form-item">
