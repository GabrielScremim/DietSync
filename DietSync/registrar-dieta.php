    ...
    <form method="post">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" id="quantidade" name="quantidade" value="<?php echo isset($quantidade) ? $quantidade : ''; ?>" placeholder="Digite a quantidade por dia">
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-4">
                <label for="data_dieta">Dia da Semana</label>
                <select class="form-control" id="data_dieta" name="data_dieta">
                    <option value="" disabled selected>Selecione um dia da semana</option>
                    <?php
                    // Array associativo com os dias da semana em português
                    ...
                    // Itera sobre os dias da semana e gera as opções do select
                    foreach ($dias_da_semana as $key => $dia) {
                        $selected = ($key == $data_dieta) ? 'selected' : '';
