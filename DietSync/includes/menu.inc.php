<div class="l-navbar" id="nav-bar">
    <nav class="nav">
        <div>
            <a href="home.php" class="nav_logo" style="margin: -15px;">
                <img src="img/vertical_1.png" alt="Logo DietSync" style="height: 50px;" style="width: 50px;">
            </a>
            <div class="nav_list">
                ...
                <?php if ($_SESSION['id'] === 1) : ?>
                    <a href="admin.php" class="nav_link <?php if ($page == 'admin') echo 'active'; ?>">
                        <i class="bi bi-eye-fill"></i>
                        <span class="nav_name">Admin</span>
                    </a>
                    <a href="grafana.php" class="nav_link <?php if ($page == 'grafana') echo 'active'; ?>">
                        <img src="img/Grafana.png" alt="grafana logo" width="25" height="25" class="mx-auto">
                    </a>
